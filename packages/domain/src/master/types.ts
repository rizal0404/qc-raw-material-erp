...
export interface VendorRecord {
  id: string; code: string; name: string; aliases: string[]; contactEmail: string | null; active: boolean; createdAt: Date; updatedAt: Date;
}
export interface PlantRecord {
  id: string; code: string; name: string; active: boolean; createdAt: Date; updatedAt: Date;
}
...
export interface EquipmentRecord {
  ...
  brand: string | null; model: string | null; aliases: string[]; active: boolean; createdAt: Date; updatedAt: Date;
}
