...
function fixtures(){
  let created:CreateStockpileLayerRepositoryInput|undefined;let reclaimerInput:Parameters<StockpileMapRepository['appendReclaimerPosition']>[0]|undefined;
  const repository={
  ...
  return{service:createStockpileMapService(repository,master,qc),created:()=>created,reclaimerInput:()=>reclaimerInput};
}
